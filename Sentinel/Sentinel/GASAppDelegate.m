...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // Settings bundle does not copy to user defaults unless user tweaks each value.
    ...
    // Ensure we have the settings loaded without the user having to go and edit a slider in Settings
